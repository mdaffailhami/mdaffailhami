...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    companyUrl: "https://aksamedia.com",
    role: "Mobile Apps Developer",
    period: "Sep 2024 - Dec 2024",
    description:
      "As a Mobile Apps Developer intern at PT Aksamedia Mulia Digital, I focus on developing and maintaining cross-platform mobile applications. My role involves collaborating with a team to create innovative solutions, following best practices in the mobile development lifecycle, and continuously improving my skills in Flutter.",
    images: [],
  },
  {
    company: "Poliban English Community (Policy)",
    companyUrl: "",
    role: "Core member of Poliban English Community",
    period: "Oct 2023 - Aug 2024",
    description: "",
    images: [],
  },
  {
    company: "Muhammadiyah",
    companyUrl: "",
  ...
  },
  {
    ...
    companyUrl: "",
    role: "Senior member of iTech Poliban",
