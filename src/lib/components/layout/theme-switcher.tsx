...
import { useIsHydrated, useBreakpoint } from "@/lib/hooks";
...
// Component defined outside to prevent recreation on every render
...
function ThemeButton({
  ...
  // If not hydrated yet or breakpoint is less than 4 (< "lg"), show button without tooltip
